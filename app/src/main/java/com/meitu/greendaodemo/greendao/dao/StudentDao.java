...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ComputerId = new Property(2, long.class, "computerId", false, "COMPUTER_ID");
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.getLong(offset + 2) // computerId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setComputerId(cursor.getLong(offset + 2));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getComputerDao().getAllColumns());
            builder.append(" FROM STUDENT T");
            builder.append(" LEFT JOIN COMPUTER T0 ON T.\"COMPUTER_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Student loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Computer computer = loadCurrentOther(daoSession.getComputerDao(), cursor, offset);
         if(computer != null) {
